        ...
        child: Container(
          ...
          child: Center(
            child: CircleAvatar(
              ...
              backgroundImage:
                  AssetImage('${kstrProfileImagePath}profile_pic.jpg'),
            ),
          ),
        ),
      ),
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  ...
                  SvgPicture.asset(svgPath('flutterflow.svg'), width: 50),
                  SvgPicture.asset(svgPath('postgresql.svg'), width: 50),
                  SvgPicture.asset(svgPath('nodejs.svg'), width: 50),
                ],
              ),
              SizedBox(height: 40),
